  ...
  return (
    <div>
      ...
      <div className='container-fluid'>
        <div className="row justify-content-around align-items-center" style={{ height: "118vh", marginTop: 10 ,marginBottom:70}}>
          <div className="col-6 p-5 shadow bg-white rounded ">
            <span className='fs-4 mb-3 fw-bolder' style={{ fontFamily: "unset" }}>
              <center><h3><i className="bi bi-person-square"></i> &nbsp;Admin Dashboard</h3></center>
            </span>
            <table style={{ marginLeft: 10, marginTop: 20, marginRight:50 }}>
              <tbody>
                <tr>
                    ...
                    <div className="card text-bg-success mb-3" style={{ maxWidth: '18rem' }}>
                      <div style={{ backgroundColor: "black" }}>
                        <NavLink to="/admin/addfaculty" style={{ textDecoration: 'none' }}>
                          ...
                          <img src="/image/teacher.png" alt="Add Faculty" className="card-img-top" style={{ width: '100%', height: 'auto', borderRadius: '0.25rem' }} />
                    ...
                    <div className="card text-bg-success mb-3" style={{ maxWidth: '18rem' }}>
                      <div style={{ backgroundColor: "black" }}>
                        <NavLink to="/admin/addstudent" style={{ textDecoration: 'none' }}>
                          ...
                          <img src="/image/student1.png" alt="Add Faculty" className="card-img-top" style={{ width: '100%', height: 'auto', borderRadius: '0.25rem' }} />
                    ...
                    <div className="card text-bg-success mb-3" style={{ maxWidth: '18rem' }}>
                      <div style={{ backgroundColor: "black" }}>
                        <NavLink to="/admin/viewstudent" style={{ textDecoration: 'none' }}>
                          ...
                          <img src="/image/viestudents.png" alt="Add Faculty" className="card-img-top" style={{ width: '100%', height: 'auto', borderRadius: '0.25rem' }} />
