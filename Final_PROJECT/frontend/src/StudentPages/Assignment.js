                    ...
                    .map(({ id, facultyName, moduleName, description, fileName }) =>
                      <tr>
                        ...
                        <div className="field">
                          ...
                          <input type="file"name="file" onChange={(e) => handleFile(e, id)} /></div>
      ...
      <tr key={id}>
        ...
        <td>
          <button className="btn btn-primary" onClick={() => handleDownload(fileName)}> 
            <i className="bi bi-box-arrow-in-down"></i> Download
          </button>
        </td>
        <td>
          {/* Flex container to align the file input and upload button in a row */}
          <div className="d-flex align-items-center">
            <div className="me-2"> {/* Add margin to the right of the input */}
              <input 
                type="file" 
                name="file" 
            ...
            <button className="btn btn-info" onClick={(e) => submitForm(e)}> 
