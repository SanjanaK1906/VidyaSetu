...
function NavBar() {
  return (
    <MDBNavbar expand='lg' light bgColor='primary' className='px-5'>
      <MDBContainer fluid>
        <MDBNavbarBrand href='#'>
          <img src='./image/images_low.png' height='40' alt='E-Vidyalaya' loading='lazy' />
          <span className='fs-4 text-white fw-semibold' >VidyaSetu </span>
        </MDBNavbarBrand>
